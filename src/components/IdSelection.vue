  ...
  created() {
    for (let i = 0; i < this.pos.length; i++) {
      switch (this.pos[i].position) {
        case "SALEMAN_M":
          this.arrPos[i] = "办事处经理(审核资料卡,创建协议书)";
          break;
        case "SALEMAN_S":
          this.arrPos[i] = "业务经理(审核资料卡,创建协议书)";
          break;
        case "MANAGER":
          this.arrPos[i] = "中心总经理(审核协议书)";
          break;
        case "VSMAPPROVEXII":
          this.arrPos[i] = "销售总监(审核协议书)";
          break;
        case "MARKETCHECKER":
          this.arrPos[i] = "市场部(审核协议书)";
          break;
        case "BILLDEP_APPROVE":
          this.arrPos[i] = "订单部(审核资料卡)";
          break;
      }
    }
  },
