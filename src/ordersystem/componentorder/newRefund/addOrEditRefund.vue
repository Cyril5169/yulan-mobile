<template>
  <div class="lanju-details">
    ...
    <span v-if="STATE == 'SUBMITTED'" class="lanju-details-state"
      >新增售后单</span
    >
    <div class="lanju-details-msg">
      <div class="msg">
        <div>
          <span class="left">客户代码</span><span class="right">系统带出</span>
        </div>
        <div>
          <span class="left">客户名称</span><span class="right">系统带出</span>
        </div>
      </div>
      <div class="msg">
        <div>
      ...
      <div class="msg">
        ...
        <div>
          ...
          ><span class="right">{{ submit.SALE_NO }}</span>
        </div>
        <div>
          <span class="left">物流单号</span
          ><span class="right">{{ submit.TRANS_ID }}</span>
        </div>

        <div>
          <span class="left">B2B订单号</span
          ><span class="right">{{ submit.orderNo }}</span>
        </div>
        <div>
          <span class="left">ERP订单号</span
          ><span class="right">{{ CONTRACT_NO }}</span>
        </div>
        <div>
          <span class="left">下单数量</span
          ><span class="right">{{ zongshuliang }}</span>
        </div>
      </div>
      ...
      <div class="msg">
        ...
        <div>
          ...
          ><span class="right">{{
            productVersionTrans(submit.PRODUCTION_VERSION)
          }}</span>
        </div>
        <div>
          <span class="left">产品型号</span
          ><span class="right">{{ submit.ITEM_NO }}</span>
        </div>
        <div>
          <span class="left">单位</span
          ><span class="right">{{ submit.UNIT }}</span>
        </div>
        <div>
...
export default {
  ...
  methods: {
    ...
    async addRefundRecord(data) {
      ...
      this.zongshuliang = res1.data[0].allCount;
